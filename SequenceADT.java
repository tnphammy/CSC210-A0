interface SequenceADT<T> {
     ...
     * @param start  The index of the first position of the range to fill in
     *               (Inclusive)
     * @param end    The index of the last position of the range to fill in
     *               (Exclusive)
     * @throws IllegalArgumentException       if start index < end index
     * @throws ArrayIndexOutOfBoundsException if either index is not within the
     *                                        sequence
     */
     ...
     * @return a negative integer if the array1 is less than array2
     *         lexicographically
     * @return a positive integer if array1 is greater than array2
     *         lexicographically.
     */
     ...
     *         (Provided all sequences had indices)
     */
